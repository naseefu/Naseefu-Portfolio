...
import { SiApachemaven, SiPostgresql, SiCloudinary, SiSocketdotio, SiMongodb, SiHibernate } from "react-icons/si";
...
const TechStack = () => {
  ...
  return (
    <div className='stack p-10 pt-5 text-[4vw] md:text-[26px] lg:pr-[10vw] lg:pl-[10vw]'>
        ...
        <p ref={(el) => sectionsRef.current[16] = el} className='mt-4 flex items-center gap-2 border border-[2px] border-[grey] rounded-xl p-2 pr-4 pl-4 '><span><SiHibernate /></span>Hibernate</p>
